...
public class KeywordFinder implements Processor {
	/**
	 * 将文本中的关键词提取出来。
	 * 
	 * @param wordsTree
	 ...
	 */
	public Set<Keyword> process(Map<String, Map> wordsTree, String text, AbstractFragment fragment, int minLen) {
		Set<Keyword> collections = new HashSet<Keyword>();
