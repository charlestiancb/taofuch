 ...
 * @author taofucheng
 */
public class SpringReflectiveXmlRpcMetaDataHandler implements XmlRpcHandler {
    ...
    private Object invoke(Object pInstance, Method pMethod, Object[] pArgs) throws XmlRpcException {
        try {
            ...
            throw new XmlRpcException("Illegal access to method " + pMethod.getName() + " in class "
                    + bean.getClass().getName(), e);
        }
        catch (IllegalArgumentException e) {
            throw new XmlRpcException("Illegal argument for method " + pMethod.getName() + " in class "
                    + bean.getClass().getName(), e);
        }
            ...
            throw new XmlRpcInvocationException("Failed to invoke method " + pMethod.getName() + " in class "
     ...
     * @param methods
     */
    public SpringReflectiveXmlRpcMetaDataHandler(AbstractReflectiveHandlerMapping pMapping,
            TypeConverterFactory pTypeConverterFactory, Object bean, Method[] pMethods, String[][] pSignatures,
            String pMethodHelp) {
        mapping = pMapping;
        this.bean = bean;
